...
try {
  ...
  foreach ($item in @('.agents', '.codex', 'AGENTS.md', 'CLAUDE.md', 'OPENCODE.md', 'opencode.json', '.cursorrules', '.windsurfrules', '.mcp.json', 'CONFIG_RELAYS.cmd', 'config_relays.ps1', 'REPAIR_ALL.cmd', 'repair.ps1', 'START_GATEWAY.cmd', '.env.example', '.gitignore')) {
