...
try {
  ...
  foreach ($item in @('.agents', '.codex', 'AGENTS.md', 'CLAUDE.md', 'OPENCODE.md', 'opencode.json', '.cursorrules', '.windsurfrules', '.mcp.json', '.gitignore')) {
